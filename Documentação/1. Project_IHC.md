...
</br>Alguns conceitos de Design usados serão citados abaixo, mas já vale citar alguns padrões que foram utilizados, como: as paletas de cores visando dois fatores, abranger usuários com distúrbios visuais e cores que fizessem referência ao Maranhão.

1° Frame:
A ideia nessa tela de login foi elaborar algo simples e direto e com uma interface bem limpa com cores 
<div align="center">
